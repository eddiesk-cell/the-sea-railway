...
// `cast` names the wardrobe a crowd is dressed in (see WARDROBE in life.js).
// Eddie: "characters of each country should be according to the movies, not
// all the same." It is one word per crowd and it changes the silhouette of a
// whole country — robes and straw hats on the old roads, aprons and bonnets
// in the European towns, head cloths in Iron Town, suits in 1920, and at the
// bathhouse, guests with no legs at all.
export const POPULATIONS = {
  sea: [
    ...
    { kind: 'walkers', cast: 'edo', n: 26, speed: 0.9, width: 6,
      path: { type: 'street', from: [-140, -60], to: [-190, -220], y: 1.4 } },
    // and the guests. They come up out of the water at dusk and go to the
    // bathhouse, and they are the reason the stalls were laid out at all.
    { kind: 'walkers', cast: 'spirit', n: 22, speed: 0.55, width: 16, scale: 1.15,
      path: { type: 'ring', at: [-268, -198], r: 120, r2: 90, y: 1.4 } },
    { kind: 'walkers', cast: 'spirit', n: 14, speed: 0.5, width: 4, scale: 1.1,
      path: { type: 'street', from: [-96, -150], to: [-232, -186], y: 1.5 } },
  ...
  drowned: [
    ...
    { kind: 'walkers', cast: 'showa', n: 10, speed: 0.9, width: 8,
  ...
  marsh: [
    ...
    { kind: 'walkers', cast: 'euro', n: 12, speed: 0.8, width: 10,
      path: { type: 'ring', at: [700, -2060], r: 44, y: 1.5 } },
  ],

  poppy: [
    { kind: 'walkers', cast: 'showa', n: 30, speed: 1.1, width: 5,
    ...
    { kind: 'walkers', cast: 'showa', n: 16, speed: 1.0, width: 8, path: { type: 'ring', at: [520, -1300], r: 34, y: 1.5 } },
  ],

  koriko: [
    { kind: 'walkers', cast: 'euro', n: 34, speed: 1.0, width: 4.4,
  ...
  cove: [
    ...
    { kind: 'walkers', cast: 'medit', n: 14, speed: 0.9, width: 10, path: { type: 'ring', at: [700, -1250], r: 34, y: 3.0 } },
  ],

  ocean: [
    { kind: 'walkers', cast: 'showa', n: 22, speed: 1.0, width: 5,
  ...
  safflower: [
    { kind: 'walkers', cast: 'showa', n: 18, speed: 0.55, width: 20, scale: 0.95,
      path: { type: 'ring', at: [-180, -1300], r: 120, r2: 70, y: 2.0 } },
    { kind: 'walkers', cast: 'showa', n: 8, speed: 0.6, width: 8, path: { type: 'ring', at: [500, -1210], r: 26, y: 1.6 } },
  ],

  tama: [
    { kind: 'cars', n: 6, speed: 9, width: 3, pause: false,
      path: { type: 'ring', at: [1000, -2200], r: 110, r2: 110, y: 1.6 } },
    { kind: 'walkers', cast: 'showa', n: 16, speed: 0.9, width: 12,
  ...
  rotary: [
    { kind: 'walkers', cast: 'showa', n: 24, speed: 1.0, width: 5,
    ...
    { kind: 'walkers', cast: 'showa', n: 12, speed: 0.85, width: 9, path: { type: 'ring', at: [520, -1240], r: 30, y: 1.5 } },
  ],
  ...
  ink: [
    { kind: 'walkers', cast: 'edo', n: 14, speed: 0.7, width: 8, scale: 0.95,
      path: { type: 'ring', at: [-260, -2650], r: 70, r2: 44, y: 1.5 } },
    { kind: 'walkers', cast: 'edo', n: 9, speed: 0.6, width: 6, path: { type: 'ring', at: [900, -3300], r: 60, y: 1.6 } },
  ],
  ...
  iron: [
    ...
    { kind: 'walkers', cast: 'worker', n: 26, speed: 0.8, width: 9, scale: 1.0,
      path: { type: 'ring', at: [-260, -1300], r: 120, r2: 90, y: 2.0 } },
    { kind: 'walkers', cast: 'worker', n: 14, speed: 0.7, width: 7, path: { type: 'ring', at: [430, -1180], r: 22, r2: 34, y: 1.6 } },
    { kind: 'walkers', cast: 'worker', n: 12, speed: 0.7, width: 10, path: { type: 'ring', at: [1080, -2380], r: 50, y: 4.6 } },
  ...
  market: [
    ...
    { kind: 'walkers', cast: 'euro', n: 30, speed: 1.0, width: 5,
      path: { type: 'street', from: [500, -1300], to: [500, -1180], y: 1.5 } },
    { kind: 'walkers', cast: 'euro', n: 20, speed: 1.0, width: 6,
  ...
  hort: [
    ...
    { kind: 'walkers', cast: 'desert', n: 34, speed: 0.95, width: 6,
    ...
    { kind: 'walkers', cast: 'desert', n: 10, speed: 0.8, width: 12, path: { type: 'ring', at: [800, -1820], r: 40, y: 1.6 } },
  ],
  ...
  valley: [
    ...
    { kind: 'walkers', cast: 'desert', n: 14, speed: 0.85, width: 10,
      path: { type: 'ring', at: [-220, -1500], r: 90, r2: 60, y: 1.6 } },
  ],

  slag: [
    { kind: 'walkers', cast: 'worker', n: 22, speed: 0.9, width: 6,
      path: { type: 'street', from: [-58, -400], to: [-58, -2400], y: 9.0 } },
    { kind: 'walkers', cast: 'worker', n: 10, speed: 0.8, width: 8, path: { type: 'ring', at: [780, -1900], r: 40, y: 26.5 } },
  ...
  laputa: [
    ...
    { kind: 'walkers', cast: 'worker', n: 8, speed: 0.7, width: 10, path: { type: 'ring', at: [560, -1600], r: 60, y: 121 } },
  ],
  ...
  wind1920: [
    ...
    { kind: 'walkers', cast: 'y1920', n: 12, speed: 0.9, width: 10, path: { type: 'ring', at: [500, -1240], r: 36, y: 1.6 } },
  ],

  tower: [
    { kind: 'boats', n: 2, speed: 1.8, width: 20,
      path: { type: 'ring', at: [-600, -1500], r: 240, r2: 180, y: 0.2 } },
    { kind: 'walkers', cast: 'showa', n: 6, speed: 0.7, width: 8, path: { type: 'ring', at: [860, -2260], r: 44, y: 1.6 } },
  ],

  sketch: [
    // four people, drawn, walking nowhere in particular
    { kind: 'walkers', cast: 'showa', n: 4, speed: 0.8, width: 4, scale: 1.1,
